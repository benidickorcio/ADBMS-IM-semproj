...
class CTKMainApp(ctk.CTk):
    ...
    def on_login_success(self, user):
        ...
        self.title("Petron Gasul Refilling Station")
    ...
    def _setup_layout(self):
        ...
        self.header_frame = ctk.CTkFrame(self, height=60, corner_radius=10, fg_color="#37E9FD")
        self.header_frame.grid(row=0, column=0, columnspan=2, sticky="ew", padx=20, pady=(20, 10))

        self.header_label = ctk.CTkLabel(
            self.header_frame,
            text="LPG Refilling Station",
            text_color="#0B0B0B",
        ...
        self.panel_frame = ctk.CTkFrame(self, corner_radius=15)
        ...
        self.pos_btn = ctk.CTkButton(self.sidebar_frame, text="💻Point of Sales", font=ctk.CTkFont(size=15, weight="bold"), command=self.show_pos, width=200, fg_color="#212222", height=40)
        self.settings_btn = ctk.CTkButton(self.sidebar_frame, text="⚙️SETTINGS", font=ctk.CTkFont(size=15, weight="bold"), command=self.show_settings, width=200, fg_color="#212222", height=40)
        self.customers_btn = ctk.CTkButton(self.sidebar_frame, text="👥Customers", font=ctk.CTkFont(size=15, weight="bold"), command=self.show_customers, width=200, fg_color="#212222", height=40)
        self.logout_btn = ctk.CTkButton(self.sidebar_frame, text="🔚Logout",font=ctk.CTkFont(size=15, weight="bold"), command=self._logout, fg_color="#212222", hover_color="#dc2626", width=200,height=40)
        ...
        self.operations_label = ctk.CTkLabel(self.sidebar_frame, text="OPERATIONS ───────", text_color="#FFEE07", font=ctk.CTkFont(size=13, weight="bold"))
        self.operations_label.pack(anchor="w", padx=10)
        self.dashboard_btn = ctk.CTkButton(self.sidebar_frame, text="📈Dashboard",font=ctk.CTkFont(size=15, weight="bold"), command=self.show_dashboard,fg_color="#212222", width=200, height=40)
        self.dashboard_btn.pack(pady=8, padx=10)
        self.sales_btn = ctk.CTkButton(self.sidebar_frame, text="💰Sales History",font=ctk.CTkFont(size=15, weight="bold"), command=self.show_sales, width=200,fg_color="#212222", height=40)
        self.sales_btn.pack(pady=8, padx=10)
        self.pos_btn.pack(pady=8, padx=10)
        
        self.management_label = ctk.CTkLabel(self.sidebar_frame, text="MANAGEMENT ──────", text_color="#FFEE07", font=ctk.CTkFont(size=13, weight="bold"))
        self.management_label.pack(anchor="w", padx=10)
        self.customers_btn = ctk.CTkButton(self.sidebar_frame, text="👥Customers",font=ctk.CTkFont(size=15, weight="bold"), command=self.show_customers,fg_color="#212222", width=200, height=40)
        self.customers_btn.pack(pady=8, padx=10)
        
        
        self.inventory_btn = ctk.CTkButton(self.sidebar_frame, text="📚Inventory",font=ctk.CTkFont(size=15, weight="bold"), command=self.show_inventory,fg_color="#212222", width=200, height=40)
        self.inventory_btn.pack(pady=8, padx=10)
        self.system_label = ctk.CTkLabel(self.sidebar_frame,text="SYSTEM ─────────", text_color="#FFEE07", font=ctk.CTkFont(size=13, weight="bold"))
        self.system_label.pack(anchor="w", padx=10)
        self.settings_btn = ctk.CTkButton(self.sidebar_frame, text="⚙️Settings",font=ctk.CTkFont(size=15, weight="bold"), command=self.show_settings,fg_color="#212222", width=200, height=40)
        self.settings_btn.pack(pady=8, padx=10)
        self.logout_btn.pack(pady=8, padx=10)
        self.show_dashboard()
